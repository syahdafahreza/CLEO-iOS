...
fn call_gta3_cheat(index: usize) {
    match index {
        ...
        // Vehicles Spawner (verified GTA III iOS binary model table)
        6 => crate::game::player::queue_spawn_vehicle(121), // GIVEUSATANK (Rhino Tank - Model 121)
        ...
        9 => crate::game::player::queue_spawn_vehicle(118), // BANSHEE (Sports - Model 118)
        10 => crate::game::player::queue_spawn_vehicle(92),  // STINGER (Sports - Model 92)
        11 => crate::game::player::queue_spawn_vehicle(135), // YAKUZA STINGER (Model 135)
        12 => crate::game::player::queue_spawn_vehicle(136), // DIABLO STALLION (Model 136)
        13 => crate::game::player::queue_spawn_vehicle(133), // MAFIA SENTINEL (Model 133)
        14 => crate::game::player::queue_spawn_vehicle(96),  // PATRIOT (Humvee - Model 96)
        15 => crate::game::player::queue_spawn_vehicle(146), // BORGNINE (Cabbie - Model 146)
        16 => crate::game::player::queue_spawn_vehicle(115), // POLICE (Police Car - Model 115)
        17 => crate::game::player::queue_spawn_vehicle(116), // ENFORCER (SWAT Van - Model 116)
        18 => crate::game::player::queue_spawn_vehicle(122), // BARRACKS OL (Military Truck - Model 122)
        ...
        21 => crate::game::player::queue_spawn_vehicle(125), // DODO (Airplane - Model 125)
        22 => crate::game::player::queue_spawn_vehicle(119), // PREDATOR (Police Boat - Model 119)
        23 => crate::game::player::queue_spawn_vehicle(141), // SPEEDER (Speed Boat - Model 141)
