...
pub static VEHICLES: &[VehicleDef] = &[
    // =========================================================================
    // GTA III Vehicle List (Verified from default.ide in game IPA)
    // Model IDs 90 to 150
    // =========================================================================
    ...
    VehicleDef { model_id: 149, name: "Toyz", category: VehicleCategory::VansTrucks, description: "Van rahasia pengendali RC Bandit" },
